//Function to get URL and compare title 
beforeEach(() => {
...
//Function to Compare Page Title
...
//Function to Search Computers by name
...
//First Testcase: To check component visibility on homepage
...
//Second Testcase to verify search functionality for invalid search
...
//Third Testcase to verify search functionality for Valid search
describe('Search Textbox functionality', () => {
...
//Forth Testcase to Verify UI components on Add Computer Page
...
//Fifth Testcase Verify UI components on Edit Computer Page
...
//Sixth Testcase for Add computer Successful
...
//Seventh Testcase for Verify Mandatory field error on Add Computer
...
//Eigth Testcase to Verify Cancel button
...
//Ninth Testcase for Search and navigate to Edit Computer
describe('Search and navigate to Edit Computer', () => {
    it('Search and navigate to edit computer', () => {
...
//Tenth Testcase for Search and Delete entry
...
//Eleventh Testcase for Verify invalid update
...
//Twelth Testcase for Search and Edit and invalid update
describe('Search and Edit and invalid update', () => {
    it('Verify invalid update', () => {
